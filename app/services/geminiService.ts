...
export const getTutorResponse = async (
	...
	try {
		...
		const chat = ai.chats.create({
			...
			config: {
				systemInstruction:
					"You are a helpful, encouraging English tutor helping a student prepare for IELTS/TOEFL. Correct their grammar gently and encourage them to use sophisticated vocabulary. Always base your definitions and usage explanations on the [GROUNDING DATA] provided in the message if available.",
			},
		});
